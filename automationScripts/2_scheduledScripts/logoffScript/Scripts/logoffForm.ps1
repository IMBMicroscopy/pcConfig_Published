...
"@
    ...
    Function Add-Button {
        ...
        New-Variable -Name logoffOutput -Value "" -Option ReadOnly -Scope Script -Force
        $Button.Add_Click({
            New-Variable -Name logoffOutput -Value $($This.Content.Text) -Option ReadOnly -Scope Script -Force
            $Window.Close()
        })
