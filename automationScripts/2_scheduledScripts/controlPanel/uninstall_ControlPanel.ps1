#script to uninstall Control Panel
...
Try{
    ...
    logdata "ppmsCP process stopped"
}Catch{logdata "ppmsCP not found or couldnt be stopped"}

#delete registry paths and task schedular tasks
$regPath = "" #tweak/define software registry path to delete if required, dont delete if empty
